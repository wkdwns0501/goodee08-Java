...
//		Calendar now = new Calendar(); // 추상 클래스라서 객체 생성 불가
		...
		int socond = now.get(Calendar.SECOND);
...
//		System.out.println(dayOfWeek);
		...
		if (today.isBefore(targetDate)) { // 지정한 날짜/시간보다 이전인지
			...
			System.out.println("오늘은 크리스마스 입니다!");
		}
		
		// 시간 비교
		LocalDateTime todayTime = LocalDateTime.now();
		LocalDateTime deadline = LocalDateTime.of(2025, 11, 27, 16, 0);
